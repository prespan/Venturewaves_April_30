...
export default function GovernmentDashboard(props: GovernmentDashboardProps) {
  ...
  // Get governmentId from URL query parameter if not provided as prop
  const governmentIdFromUrl = router.query.id ? parseInt(router.query.id as string) : null;
  const governmentId = props.governmentId || governmentIdFromUrl;
  
  const { organizationName, organizationId } = props;
  
  const { data: challenges, loading: challengesLoading, error: challengesError } = useGovernmentChallenges(governmentId!);
  const { data: proposals, error: proposalsError } = useGovernmentProposals(governmentId!);
  const { data: projects, error: projectsError } = useGovernmentProjects(governmentId!);
  const { data: partners, error: partnersError } = useGovernmentPartners(governmentId!);
  ...
  // Show loading state if we don't have a governmentId yet
  if (!governmentId) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 -mx-16 -my-16 px-16 py-16">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <button 
              onClick={() => router.push(`/challenges/create?orgType=GOVERNMENT&orgId=${governmentId}&orgName=${organizationName || 'Government'}`)}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            {displayChallenges.length > 0 ? displayChallenges.map((challenge: any) => (
              ...
              <div className="col-span-full bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                ...
                <p className="text-gray-500">Create your first public innovation challenge to get started.</p>
              </div>
            )}
          </div>
        )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium text-gray-900">Founders Factory</span>
                      <span className="text-xs text-gray-500">2 hours ago</span>
                    </div>
                    <p className="text-sm text-gray-600">Proposal submission for Smart City Infrastructure challenge</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 hover:bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium text-gray-900">Public Digital</span>
                      <span className="text-xs text-gray-500">1 day ago</span>
                    </div>
                    <p className="text-sm text-gray-600">Update on Digital Health Records integration project</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 hover:bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium text-gray-900">Tech Nation Applied</span>
                      <span className="text-xs text-gray-500">3 days ago</span>
                    </div>
                    <p className="text-sm text-gray-600">Partnership proposal for Climate Monitoring project</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <h4 className="font-medium text-green-900 mb-2">Communication Guidelines</h4>
                <ul className="text-sm text-green-700 space-y-1">
                  <li>• Keep messages professional and transparent</li>
                  <li>• Include relevant challenge/project references</li>
                  <li>• Respond to studio inquiries within 24 hours</li>
                  <li>• Ensure public accountability standards</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-3 border-l-4 border-green-500 bg-green-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium text-gray-900">Smart City Infrastructure - Proposal Deadline</span>
                      <span className="text-xs text-gray-500">Tomorrow</span>
                    </div>
                    <p className="text-sm text-gray-600">Final submissions due by 5:00 PM GMT</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 border-l-4 border-blue-500 bg-blue-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium text-gray-900">Public Innovation Review</span>
                      <span className="text-xs text-gray-500">Dec 15</span>
                    </div>
                    <p className="text-sm text-gray-600">Quarterly review of all public innovation projects</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 border-l-4 border-purple-500 bg-purple-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium text-gray-900">Citizen Consultation Meeting</span>
                      <span className="text-xs text-gray-500">Dec 20</span>
                    </div>
                    <p className="text-sm text-gray-600">Public meeting on Climate Change Monitoring results</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                  ...
                  <span className="text-gray-900">Schedule Public Meeting</span>
                </button>
